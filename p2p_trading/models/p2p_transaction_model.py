...
class Transaction(BaseModel):
    ...
    amount = models.DecimalField(max_digits=20, decimal_places=8) # يمكن أن يكون موجب أو سالب
    running_balance = models.DecimalField(max_digits=20, decimal_places=8) # رصيد المحفظة بعد هذه المعاملة
